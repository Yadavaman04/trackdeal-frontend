<template>
  <Teleport to="body">
    <Transition name="drawer-slide">
      ...
      >
        <div
          class="w-full max-w-lg h-full border-l shadow-2xl overflow-hidden flex flex-col transition-all duration-150"
        ...
        <!-- Body Form -->
        <form @submit.prevent="handleSubmit" class="p-5 space-y-4 flex-1 overflow-y-auto">
          <!-- Error alert -->
          <div
            v-if="errorMessage"
